...
void set_text_speed(bool fast_speed, bool save)
{
	...
	SEND_BUTTON_SEQUENCE(
		...
		{ BT_NONE,	DP_DOWN,	SEQ_MASH,	1 },	/* Move to Map position */
...
void get_egg(void)
{
	SEND_BUTTON_SEQUENCE(
		...
		{ BT_NONE,	DP_DOWN,	SEQ_MASH,	1  },	/* Go to second Pokémon */
		{ BT_A,		DP_DOWN,	SEQ_HOLD,	65 },	/* Select second Pokémon */
		{ BT_NONE,	DP_NEUTRAL,	SEQ_HOLD,	1  },	/* Release A */
		{ BT_A,		DP_DOWN,	SEQ_HOLD,	35 },	/* Validate “… sent to box” dialog */
		{ BT_NONE,	DP_NEUTRAL,	SEQ_HOLD,	1  },	/* Release A */
		{ BT_A,		DP_DOWN,	SEQ_MASH,	1  },	/* Validate “Take care” dialog */
