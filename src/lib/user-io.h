...
enum pins_t {
	...
	/* PORTB */
	PIN_BUZZER = (1 << 0), 			/* Buzzer on digital pin 8 port B */
	PIN_INPUT_TYPE = (1 << 2), 		/* Input type on digital pin 10 port B */
	PIN_LED = (1 << 5), 			/* LED on digital pin 13 port B */

	/* PORTD */
	PIN_MAIN_BUTTON = (1 << 2), 	/* Button on digital pin 2 port D */
	PIN_TEST_BUTTON = (1 << 3), 	/* Button on digital pin 3 port D */
	PIN_TEST_BUTTON2 = (1 << 4), 	/* Button on digital pin 4 port D */
	PIN_TEST_BUTTON3 = (1 << 5), 	/* Button on digital pin 5 port D */
	PIN_SWITCH_INPUT = (1 << 6), 	/* Button on digital pin 6 port D */
};
...
extern struct pin_t led_pin;
extern struct pin_t buzzer_pin;
...
typedef struct button_info {
	...
	struct pin_t button; /* Pin number of the button to press */
};
